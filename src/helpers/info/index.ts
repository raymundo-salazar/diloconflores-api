...
export const calculatePages: PagesFn = (page: number, records: number, limit: number) => {
	return {
		current: page,
...
export const calculateTotal: TotalFn = (records: number, totalRecords: number, offset: number) => {
	return {
		total: totalRecords,
		show: records,
